...
S01 = '''<section class="sec">
    ...
    <table class="tab">
      ...
      <tr><th>Unidade</th><td>Apto 04 — térreo</td></tr>
      <tr><th>Capacidade</th><td>Até 11 pessoas — 3 suítes e sofá-cama na sala</td></tr>
      <tr><th>Garagem</th><td>2 vagas, sem numeração — estacione em qualquer uma livre</td></tr>
...
S03 = '''<section class="sec">
    ...
    <ol class="passos">
      ...
      <li><strong>Estacione na garagem.</strong> O apartamento tem 2 vagas, sem numeração — pode usar qualquer uma que estiver livre.</li>
      <li><strong>O Apto 04 fica no térreo.</strong> Entrada sem escada, no mesmo nível da garagem.</li>
    </ol>
    ...
    <div class="col2">
      <div class="col-tem">
        ...
        <div class="grupo"><h4>Quartos</h4><ul class="lista-check">
          ...
          <li>Uma suíte no térreo, no mesmo nível da entrada; as outras duas no andar de cima, por escada interna</li>
          <li>2 camas de casal e 6 de solteiro</li>
          <li>Sofá-cama na sala</li>
          <li>Roupa de cama completa — não precisa levar</li>
          <li>Toalhas de banho fornecidas pelo condomínio</li>
        </ul></div>
