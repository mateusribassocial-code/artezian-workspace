...
Fontes:
  ...
  HA03J - Operacional.md                 -> campainha eletronica, sem portaria 24h
...
S01 = '''<section class="sec">
    ...
    <div class="aviso"><strong>Este imóvel não tem portaria 24h.</strong> Sua entrada é liberada pela campainha eletrônica na chegada, e o plantão da Artezian é o seu contato para tudo — chegada, dúvida, problema. Salve o número antes de viajar.</div>
    ...
    <div class="mapa-linha">
      <div class="mapa-txt">
        ...
        <ul class="lista">
          ...
          <li>Se vier de táxi ou aplicativo, confira o número na fachada antes de dispensar o carro — não há portaria para conferir por você.</li>
        </ul>
      </div>
...
S03 = '''<section class="sec">
    ...
    <div class="aviso"><strong>Se ninguém atender a campainha, não fique esperando.</strong> Chame o plantão da Artezian no WhatsApp <strong>%s</strong>. Como não há portaria 24h no local, somos nós que resolvemos — e quanto antes você chamar, mais rápido.</div>
  </section>''' % WPP_FMT
