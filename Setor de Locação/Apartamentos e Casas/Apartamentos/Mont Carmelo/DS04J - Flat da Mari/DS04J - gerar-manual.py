...
S01 = '''<section class="sec">
    ...
    <table class="tab">
      ...
      <tr><th>Camas</th><td>1 king size, 2 de solteiro e 1 sofá-cama na sala</td></tr>
...
S03 = '''<section class="sec">
    ...
    <ol class="passos">
      ...
      <li><strong>Estacione na vaga do flat.</strong> É uma vaga por unidade. Se vierem dois carros, há estacionamento na rua.</li>
    </ol>
...
S05 = '''<section class="sec junto">
    ...
    <div class="col2">
      <div class="col-tem">
        ...
        <div class="grupo"><h4>Dormir</h4><ul class="lista-check">
          <li>1 cama king size e 2 de solteiro</li>
          ...
          <li>Distribuição dos quartos <span class="ph">confirmar</span></li>
        </ul></div>
    ...
    <div class="aviso"><strong>O flat é de dois andares, com escada interna.</strong> Se alguém do grupo tem dificuldade com escada, vale combinar antes quem fica embaixo — a entrada é sem degraus, mas parte dos cômodos fica em cima.</div>
  </section>'''
