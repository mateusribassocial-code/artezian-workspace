# -*- coding: utf-8 -*-
"""Gera o Manual do Hospede do JR01J (Studio Varandas 01) — Varandas de Porto.
...
Fontes:
  ...
  artezian.com.br/pt/apartment/JR01J       -> horarios, regras, enxoval, banheiro
  fotos da unidade                         -> numero 01 na porta, barra no box
...
BASE = "Setor de Locação/Apartamentos e Casas/Apartamentos/Varandas de Porto/JR01J - Studio Varandas 01"
SCAFFOLD = ".claude/skills/manual-hospede/assets/base-a4.html"
SAIDA = "Setor de Locação/PDFS/JR01J - Manual do Hospede.html"

NOME = "Studio Varandas 01"
CODIGO = "JR01J"
...
SELECAO = [
    ("JR01J-1.png", "A varanda e a entrada do Studio 01", True),
    ("JR01J-3.png", "O studio, com saída para a varanda", False),
    ("JR01J-2.png", "Cozinha compacta", False),
    ("JR01J-4.png", "Panelas, chaleira e utensílios", False),
    ("7.png", "Roupa de cama e toalhas já no quarto", False),
    ("JR01J-5.png", "Guarda-roupa e frigobar", False),
    ("11.png", "Banheiro com barra de apoio no box", False),
]
...
S05 = '''<section class="sec junto">
    ...
    <div class="col2">
      <div class="col-tem">
        ...
        <div class="grupo"><h4>Dormir</h4><ul class="lista-check">
          <li>Cômodo único, com cama de casal e uma cama adicional</li>
        ...
        <div class="grupo"><h4>Banheiro e varanda</h4><ul class="lista-check">
          ...
          <li>Varanda na frente do studio</li>
          <li>TV</li>
        </ul></div>
      </div>
      <div class="col-levar">
    ...
    <div class="aviso"><strong>É um studio de cômodo único</strong> — as camas dividem o mesmo espaço, sem parede entre elas. E a cozinha é compacta: resolve café da manhã e refeição simples, não um jantar para quatro.</div>
  </section>'''
