...
S01 = '''<section class="sec">
    ...
    <table class="tab">
      ...
      <tr><th>Quartos</th><td><span class="ph">confirmar</span> — a distribuição das camas está na seção 05</td></tr>
...
S03 = '''<section class="sec">
    ...
    <ol class="passos">
      ...
      <li><strong>Retirada das chaves:</strong> <span class="ph">confirmar como funciona</span></li>
      <li><strong>Estacione na casa.</strong> São 5 vagas mais a garagem.</li>
    </ol>
    <div class="aviso"><strong>Esta é uma casa, não um condomínio — não há portaria 24h.</strong> Por isso o horário combinado importa: se o voo atrasar ou o trajeto render, avise na hora. O plantão da Artezian é o seu contato para tudo.</div>
  </section>'''
    ...
    <div class="col2">
      <div class="col-tem">
        ...
        <div class="grupo"><h4>Dormir</h4><ul class="lista-check">
          <li>Quartos com beliches e quartos com camas de casal e solteiro</li>
          <li>Sofá-cama</li>
          <li>Ar-condicionado individual em cada quarto</li>
          <li>Ventiladores de teto</li>
          <li>Guarda-roupas</li>
          <li>Roupa de cama, travesseiros e toalhas inclusos</li>
          <li>Distribuição exata dos quartos <span class="ph">confirmar</span></li>
        </ul></div>
...
S06 = '''<section class="sec junto">
    ...
    <div class="aviso"><strong>Confira a voltagem antes de ligar aparelhos trazidos de casa</strong> <span class="ph">confirmar</span>. Secador de cabelo e chapinha são os que queimam.</div>
  </section>'''
...
S11 = '''<section class="sec junto">
    ...
    <ul class="lista-check">
      <li><strong>Combine o horário da saída com antecedência</strong></li>
      <li>Devolução das chaves <span class="ph">confirmar</span></li>
