...
S07 = '''<section class="sec junto">
    ...
    <table class="tab">
      ...
      <tr><th>Área de festas</th><td>Ampla, integrada à piscina. <strong>Evento precisa ser combinado antes</strong> — ver seção 11</td></tr>
...
S11 = '''<section class="sec junto">
    ...
    <ul class="lista">
      <li><strong>Eventos são permitidos</strong> — a casa tem área de festas integrada à piscina. Mas precisam ser <strong>avisados antes e combinados no contrato</strong>. Se você pretende fazer um evento aqui, fale com a gente na reserva, não na véspera.</li>
      <li>Silêncio a partir das 22h. A casa fica em rua residencial e os vizinhos moram ali.</li>
